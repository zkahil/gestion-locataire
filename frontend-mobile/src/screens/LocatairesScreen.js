...
const LocatairesScreen = () => {
    ...
    return (
        <ScrollView style={styles.container}>
            <View style={styles.header}><Text style={styles.title}>Locataires</Text><Text style={styles.subtitle}>{data.length} elements</Text></View>
            {data.map((item, i) => (
...
export default LocatairesScreen;
